...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React9.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React9.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React9.useMemo(() => storageManager == null ? void 0 : storageManager({
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GCWAOTMB.js.map
