...
const SwarmVisualizerView = () => {
    ...
    const { data: requirements = [] } = useRequirementsDone(
        ...
        { fields: 'id,title,completed_at,category_fk,requirement_status,coordination_type,ai_model,effort' }
    );
    ...
    const { data: allRequirements = [] } = useAllRequirements(
        profile?.userName,
        { fields: 'id,title,category_fk,coordination_type,ai_model,effort,requirement_status,completed_at,started_at' },
    );
