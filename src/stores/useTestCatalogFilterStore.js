...
// (req #2380; the Features page these once also served was retired by req #3357).
...
//
// `statusFilter`/`coverageFilter` (Features-only enums) were retired with
// FeaturesPage — req #3357 item 2.
